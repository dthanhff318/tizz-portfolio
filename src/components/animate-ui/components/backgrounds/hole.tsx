...
function HoleBackground({
	...
	const tick = React.useCallback(() => {
		...
		moveParticles();
		// drawDiscs(ctx);
		// drawLines(ctx);  // Commented out to remove lines
		drawParticles(ctx);
		ctx.restore();
	...
	return (
		...
		>
			...
			<motion.div
				className={cn(
					"absolute top-[-71.5%] left-1/2 z-[3] w-[30%] h-[140%] rounded-b-full blur-3xl opacity-75 [transform:translate3d(-50%,0,0)] [background-position:0%_100%] [background-size:100%_200%]",
					"[background:linear-gradient(90deg,#ffffff_0%,#bbbbbb_20%,#666666_50%,#bbbbbb_80%,#ffffff_100%)_0_100%_/_100%_200%]"
				)}
